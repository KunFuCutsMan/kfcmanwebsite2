...
{{<figure
    src="./cool-nightstand-i-found.png"
    alt="Cool night stand recreation"
    hint="icon"
    caption="Rough pixel art recreation of the night stand in question. It had a glittery blue liquid, a floating astronaut and lights which could be switched on for a cool effect."
>}}
...
{{<figure
    src="./white-baskets.png"
    alt="Basket recreation"
    hint="icon"
    caption="A rough pixel art recreation of one of baskets we bought."
>}}
...
We paid for the baskets (only $60 MXN, nice!) and went straight for the bus stop. On our way we joked about our experience and the _slim_ possibility that we might have entered an alternative version of our world or landed in a different time than the present. Thankfully none of that happened. ~I think.~
